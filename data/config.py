...
CITYSCAPES_CLASSES = ('person', 'bicycle', 'car', 'motorcycle', 'pole', 'bus',
                      'train', 'traffic sign', 'traffic light', 'truck', 'fire hydrant',
                      'stop sign', 'parking meter', 'bench', 'bird', 'cat', 'dog',
                      'horse', 'sheep', 'cow', 'elephant', 'bear', 'zebra', 'giraffe',
                      'backpack', 'umbrella', 'handbag', 'tie', 'suitcase', 'frisbee',
                      'skis', 'snowboard', 'sports ball', 'kite', 'baseball bat',
...
cityscapes_pad = cityscapes_base.copy({
    ...
    'valid_info': '/home/tunghandsome/Tung/cityscapes/pad_anno/instancesonly_filtered_gtFine_val.json',
...
yolact_resnet50_tung_config = yolact_base_config.copy({
    'name': 'yolact_tung_resnet50',
    ...
    # Training params
    'lr_steps': (20000, 60000, 70000, 75000),
    'max_iter': 80000,
